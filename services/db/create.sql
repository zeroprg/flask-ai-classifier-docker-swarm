...
--- drop  table  objects;
CREATE TABLE objects(hashcode int8 PRIMARY KEY, currentdate TEXT, currentime int8, lastdate TEXT, lasttime int8, type TEXT, frame TEXT, x_dim int, y_dim int, cam int, cam_uuid uuid);
