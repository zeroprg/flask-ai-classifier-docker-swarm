...
# Read all production configuration from config.txt file
...
topic_rules = {
    ...
    "vehicles": (["car", "bus", "train", "motorbike", "bicycle"], 1),
    ...
    "outdoor": (["tree", "flower", "building", "sky", "grass"], 1), 
    "water": (["boat", "swimming pool", "beach", "surfboard", "umbrella"], 1),
