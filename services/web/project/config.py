...
class ProductionConfig:
    ...
    PROCCESS_BATCH_SIZE = os.environ.get("PROCCESS_BATCH_SIZE")
    ...
    if PROCCESS_BATCH_SIZE is None or PROCCESS_BATCH_SIZE =='' : PROCCESS_BATCH_SIZE =  args["PROCCESS_BATCH_SIZE"]